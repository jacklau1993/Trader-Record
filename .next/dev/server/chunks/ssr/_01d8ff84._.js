...
const getCategories = ()=>{
    if ("TURBOPACK compile-time truthy", 1) return INITIAL_CATEGORIES;
    //TURBOPACK unreachable
    ;
...
const getSections = ()=>{
    if ("TURBOPACK compile-time truthy", 1) return INITIAL_SECTIONS;
    //TURBOPACK unreachable
    ;
    const stored = undefined;
};
...
const getTemplates = ()=>{
    if ("TURBOPACK compile-time truthy", 1) return INITIAL_TEMPLATES;
    //TURBOPACK unreachable
    ;
    const stored = undefined;
};
...
function AddTradeModal({ onTradeAdded }) {
    ...
    const handleSubmit = (e)=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveTrade"])(trade);
        // Auto-create Note in Notebook
        const sections = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSections"])();
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveNote"])(newNote);
        onTradeAdded();
        setIsOpen(false);
        setFormData({
            type: "Long"
...
//# sourceMappingURL=_01d8ff84._.js.map