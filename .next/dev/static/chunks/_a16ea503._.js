...
"[project]/app/trades/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TradesListPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TradesListPage.useEffect": ()=>{
            // Sort reverse chronological
            const loadedTrades = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTrades"])().sort({
                "TradesListPage.useEffect.loadedTrades": (a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime()
            }["TradesListPage.useEffect.loadedTrades"]);
            setTrades(loadedTrades);
        }
    }["TradesListPage.useEffect"], []);
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TradesListPage.useMemo[stats]": ()=>{
            let netPnl = 0;
            let grossProfit = 0;
            let grossLoss = 0;
            let wins = 0;
            ...
            trades.forEach({
                "TradesListPage.useMemo[stats]": (t)=>{
                    netPnl += t.pnl;
                    if (t.pnl > 0) {
                        grossProfit += t.pnl;
                        wins++;
            ...
            const losses = totalTrades - wins; // Assuming 0 P&L is loss or filtered, but here simple math
            // Wait, realistically break-even trades exist. But assuming simple win/loss count:
            // Let's count strictly positive as win, negative as loss.
            const losingTradesCount = trades.filter({
                "TradesListPage.useMemo[stats]": (t)=>t.pnl < 0
            }["TradesListPage.useMemo[stats]"]).length;
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                    ...
                    fileName: "[project]/app/trades/page.tsx",
                    lineNumber: 60,
                    columnNumber: 17
                }, this)
            }, void 0, false, {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    ...
                                    children: trades.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        ...
                                        lineNumber: 106,
                                        columnNumber: 37
                                    }, this) : trades.map((trade)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            className: "border-b transition-colors hover:bg-muted/50 cursor-pointer",
                                            onClick: ()=>router.push(`/trades/${trade.id}`),
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "p-4 align-middle",
                                                    children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(trade.date), 'MMM dd, yyyy')
                                                }, void 0, false, {
                                                    fileName: "[project]/app/trades/page.tsx",
                                                    lineNumber: 116,
                                                    columnNumber: 45
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: `px-2 py-1 rounded text-xs ${trade.type === 'Long' ? 'bg-green-500/10 text-green-500' : 'bg-red-500/10 text-red-500'}`,
                                                        children: trade.type
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/trades/page.tsx",
                                                        lineNumber: 119,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "p-4 align-middle",
                                                    children: trade.contracts || trade.quantity || '-'
                                                }, void 0, false, {
                                                    fileName: "[project]/app/trades/page.tsx",
                                                    lineNumber: 124,
                                                    columnNumber: 45
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: `p-4 align-middle text-right font-bold ${trade.pnl > 0 ? 'text-green-500' : 'text-red-500'}`,
                                                    children: [
                                                        "$",
                                                        trade.pnl.toFixed(2)
                                                    ]
...
_s(TradesListPage, "l1E3Zk1RVTbvHVOKg50Rk5fOOkA=", false, function() {
    return [
...
_c = TradesListPage;
var _c;
__turbopack_context__.k.register(_c, "TradesListPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_a16ea503._.js.map